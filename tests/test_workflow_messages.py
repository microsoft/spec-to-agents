...
def test_user_elicitation_request_creation():
    ...
    msg = UserElicitationRequest(prompt="Test prompt", context={"venues": ["A", "B", "C"]}, request_type="selection")
...
def test_user_elicitation_request_is_request_info_message():
    ...
    msg = UserElicitationRequest(prompt="Test", context={}, request_type="clarification")
